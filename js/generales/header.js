...
headerContenedorInferior.innerHTML = `
    <div class="container-fluid">
        <a class="navbar-brand" href="/uberwinden/index.html"><img src="/uberwinden/assets/images/logoUberwinden.png" alt="Logo Überwinden" id="logoMarca"/></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto me-2 mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="./uberwinden/index.html">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/uberwinden/pages/nosotros.html">Nosotros</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false">Productos</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item fw-bold" href="/uberwinden/pages/indumentaria_paravos.html">Para vos...</a></li>
                        <li><a class="dropdown-item ps-5" href="/uberwinden/pages/productos.html?categoria=Hombre">Hombre</a></li>
                        <li><a class="dropdown-item ps-5" href="/uberwinden/pages/productos.html?categoria=Mujer">Mujer</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item fw-bold" href="/uberwinden/pages/personaliza_tu_indumentaria.html">Para tu club...</a></li>
                        <li><a class="dropdown-item ps-5" href="/uberwinden/pages/en_construccion.html">Merchandising</a></li>
                        <li><a class="dropdown-item ps-5" href="/uberwinden/pages/personaliza_tu_indumentaria.html">Personaliza tu indumentaria</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/uberwinden/pages/eventos.html">Eventos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/uberwinden/pages/login.html"><i class="fa-solid fa-user"></i></a>
                </li>
                <li class="nav-item">
