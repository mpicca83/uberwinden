    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto me-2 mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="${ruta}/index.html">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${ruta}/pages/nosotros.html">Nosotros</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false">Productos</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item fw-bold" href="${ruta}/pages/indumentaria_paravos.html">Para vos...</a></li>
                        <li><a class="dropdown-item ps-5" href="${ruta}/pages/productos.html?categoria=Hombre">Hombre</a></li>
                        <li><a class="dropdown-item ps-5" href="${ruta}/pages/productos.html?categoria=Mujer">Mujer</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item fw-bold" href="${ruta}/pages/personaliza_tu_indumentaria.html">Para tu club...</a></li>
                        <li><a class="dropdown-item ps-5" href="${ruta}/pages/en_construccion.html">Merchandising</a></li>
                        <li><a class="dropdown-item ps-5" href="${ruta}/pages/personaliza_tu_indumentaria.html">Personaliza tu indumentaria</a></li>
                    </ul>
                </li>
                <li class="nav-item">
