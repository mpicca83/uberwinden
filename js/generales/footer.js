...
footerContenedor.innerHTML = `
    <ul class="tiendaOnline">
        ...
        <li><a href="/pages/productos.html?categoria=Hombre">Hombre</a></li>
        <li><a href="/pages/productos.html?categoria=Mujer">Mujer</a></li>
        <li><a href="/pages/en_construccion.html">Merchandising clubes</a></li>
        <li><a href="/pages/personaliza_tu_indumentaria.html">Personaliza tu indumentaria</a></li>
    </ul>
    <ul class="ayuda">
        <li><h5>Ayuda</h5></li>
        <li><a href="/pages/en_construccion.html">Preguntas frecuentes</a></li>
        <li><a href="/pages/en_construccion.html">Politica de envíos</a></li>
        <li><a href="/pages/en_construccion.html">Cambio y devoluciones</a></li>
        <li><a href="/pages/en_construccion.html">Medios de pago</a></li>
        <li><a href="/pages/en_construccion.html">Cancelación de compra</a></li>
    </ul>
    <ul class="acercaDe">
        <li><h5>Acerca de Überwinden</h5></li>
        <li><a href="/pages/nosotros.html">Quines somos</a></li>
        <li><a href="/pages/eventos.html">Eventos</a></li>
        <li><a href="/pages/en_construccion.html">Tiendas</a></li>
    </ul>
    <ul class="usuario">
        <li><h5>Usuario</h5></li>
        <li><a href="/pages/login.html">Iniciar sesión</a></li>
        <li><a href="/pages/registro.html">Registrate</a></li>
    </ul>
    <ul class="iconos">
